        ...
        <div class="row form-center">
            ...
            <div class="col-md-6 my-1">
                <div class="form-group">
                    ...
                    <input type="text" name="std_username" class="form-control my-2" placeholder="กรอกชื่อผู้ใช้">
            ...
            <div class="col-md-6 my-1">
                <div class="form-group">
                    ...
                    <input type="text" name="std_password" class="form-control my-2" placeholder="กรอกรหัสผ่าน">
