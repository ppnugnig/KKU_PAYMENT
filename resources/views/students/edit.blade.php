        ...
        <div class="row form-center">
            ...
            <div class="col-md-6 my-1">
                <div class="form-group">
                    ...
                    <input type="text" name="std_username" class="form-control my-2" value="{{$student->std_username}}" placeholder="กรอกชื่อผู้ใช้">
            ...
            <div class="col-md-6 my-1">
                <div class="form-group">
                    ...
                    <input type="text" name="std_password" class="form-control my-2" value="{{$student->std_password}}" placeholder="กรอกรหัสผ่าน">
